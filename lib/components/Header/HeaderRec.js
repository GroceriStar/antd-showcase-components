...
function (_Component) {
  ...
  function Header() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleReload", function (e) {
      console.log('click ', e);
      console.log((0, _selectors.getRandomRecipe)()); // reloading data
      // this.setState({
      //   data: []
      // })
    });
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_antd.Menu, {
        ...
        type: "plus-square"
      }), "Add Recipe Modal"), _react.default.createElement(_Modal.default, {

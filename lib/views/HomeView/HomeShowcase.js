...
var _antdShowcaseComponents = require("@groceristar/antd-showcase-components");
...
function (_Component) {
  ...
  function HomeRecipeView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "shuffle", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "setColumns", function (e) {
      return _this.setState({
        columns: parseInt(e.key, 10)
      });
    });

    _defineProperty(_assertThisInitialized(_this), "setMargin", function (e) {
      return _this.setState({
        margin: parseInt(e.key, 10)
      });
    });

    _defineProperty(_assertThisInitialized(_this), "setHeight", function (e) {
      return _this.setState({
        height: e
      });
    });

    _defineProperty(_assertThisInitialized(_this), "grocery", []);
  ...
  _createClass(HomeRecipeView, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: "main"
      }, _react.default.createElement(_antdShowcaseComponents.HeaderShowcase, _extends({}, this.state, {
        search: this.search,
